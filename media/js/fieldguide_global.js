if (typeof FIELDGUIDE == 'undefined') FIELDGUIDE = {};
if (typeof FIELDGUIDE.Globals == 'undefined') FIELDGUIDE.Globals = {};
if (typeof FIELDGUIDE.Messages == 'undefined') FIELDGUIDE.Messages = {};

/* ============================= */
/* = Core FIELDGUIDE Functions = */
/* ============================= */

FIELDGUIDE.log = function(msg) {
    try {
        if (typeof o == "object") {
            var new_m = [];
...
(function($) {
    ...
    $.fn.extend({
        ...
        'pulseBackground': function(pulse_color) {
            ...
            if ($this.css('backgroundColor')
                ...
                original_bgcolor = $this.css('backgroundColor');
            } else {
                original_bgcolor = 'white';
            }
            // FIELDGUIDE.log(['Color', pulse_color, original_bgcolor, $this.css('backgroundColor')]);
            $this.css({'background-color': original_bgcolor})
                 .animate({'backgroundColor': pulse_color}, 500)
                 .animate({'backgroundColor': original_bgcolor}, 500, function() {
    ...
    $.extend({
		...
		rescope: function(func, thisArg){
			return function(a, b, c, d, e, f){
				return func.call(thisArg, this, a, b, c, d, e, f);
			};
		}
